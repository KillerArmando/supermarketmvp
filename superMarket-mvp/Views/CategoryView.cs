    ...
    public partial class CategoryView : Form, ICategoryView
    {
        ...
        private void AssociatedAndRaiseViewEvents()
        {
            ...
            BtnNew.Click += delegate
            {
                ...
                tabControl1.TabPages.Remove(tabCategoryModeList);
            ...
            BtnEdit.Click += delegate
            {
                ...
                tabControl1.TabPages.Remove(tabCategoryModeList);
                tabControl1.TabPages.Add(tabPageCategoryDetail);
                tabPageCategoryDetail.Text = "Edit Pay Mode";
            };
            ...
            BtnSave.Click += delegate
            {
                ...
                if (isSuccessful)
                {
                    ...
                    tabControl1.TabPages.Remove(tabPageCategoryDetail);
                    tabControl1.TabPages.Add(tabCategoryModeList);
        ...
        {
            DgCategory.DataSource = categorieList;
        }
